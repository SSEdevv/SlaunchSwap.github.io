...
export default function SwapForm({ setIsChartDisplayed, isChartDisplayed, isAccessTokenSupported }) {
  ...
  return (
    <>
      <>
        <CurrencyInputHeader
          title={t('پیش فروش بزرگ $SSE')}
          subtitle={t('Buy SSE PRESALE SOROOSH SMART SLAUNCH پیش فروش بزرگ کامیونیتی ایران در اس لانچ 1 تا 100 بی ان بی')}
          ...
          <AutoColumn gap="sm">
            ...
            {showWrap ? null : (
              <AutoColumn gap="7px" style={{ padding: '0 16px' }}>
                ...
                <RowBetween align="center">
                  <Label>{t('با سروش اسمارت اکوسیستم دنیای وب ۳ را تغییر خواهیم داد (سروش اسیوند : فاندر پروژه)')}</Label>
